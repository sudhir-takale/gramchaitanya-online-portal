...
<head>
    ...
    <title>apply for documents</title>
...
<body style="background-color: steelblue;;">
    ...
    <div class=" container h-custom"
        ...
        <div class="form-group mt-2">
            <form>
                ...
                <label for="exampleInputEmail1">Enter document name</label>
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                    placeholder="Enter name of document you want">
        ...
        <div class="form-group mt-2">
            <label for="exampleInputPassword1">Enter purpose</label>
            <input type="password" class="form-control" id="exampleInputPassword1"
                placeholder="Enter the purpose of document">
        </div>
        <div class="form-group mt-2">
            <label for="exampleInputPassword1">Upload required documents</label>
    ...
    <div class="documents " style="margin-top: 6%;">


        <h2 class="text-center">List of required document</h2>
